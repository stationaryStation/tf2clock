...
const Home = () => {
    ...
    }, [difference_in_days,difference_in_time, difference_in_hours])
    ...
    return (
        ...
        <Head>
            ...
            <meta property="og:description" content={`It has been: ${difference_in_days} days or ${difference_in_hours} hours or ${difference_in_time} ms since jungle inferno released`} key="description" />
